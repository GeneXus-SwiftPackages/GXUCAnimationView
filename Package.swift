...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.8.xcframework.zip",
			checksum: "4ddf8ed7f65a9f2dc0b8f779e8b0e6f8fcb077ea2276160146b8398d02ddea51"
		)
	]
)