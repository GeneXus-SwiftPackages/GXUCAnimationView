...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.19.xcframework.zip",
			checksum: "26da6ad15fb57f17d1eb50c7f0866d640484be69399eda35aacc824b47fd653b"
		)
	]
)