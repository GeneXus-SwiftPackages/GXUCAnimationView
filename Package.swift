...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.9.xcframework.zip",
			checksum: "9062349dfb26c488d7aca4d57e1be9aab5aea7f4a830c23482b4c6b2f2461239"
		)
	]
)