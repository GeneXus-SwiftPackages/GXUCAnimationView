...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-5.0.0-beta.1.xcframework.zip",
			checksum: "95e11c542241d77cc50f5123c81843ad283fb19486d6bb9ac044832b413551af"
		)
	]
)