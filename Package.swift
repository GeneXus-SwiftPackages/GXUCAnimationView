...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-2.0.17.xcframework.zip",
			checksum: "af54a395c05d5eb0d2f26543e496de85a3eca683b5d62a7538a930a0996df96e"
		)
	]
)