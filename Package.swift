...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.5.xcframework.zip",
			checksum: "d3e799c71aa38c0062feba32acc40ad60483e1a55a6ffe95d8ad40ccb09c9dd6"
		)
	]
)