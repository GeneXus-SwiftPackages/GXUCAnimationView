...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.18.xcframework.zip",
			checksum: "b686ef2df2600785c6ffa0a27181ebef774dbd89713f21b1a149e9ff32b310c4"
		)
	]
)