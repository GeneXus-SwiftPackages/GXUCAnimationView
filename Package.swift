...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.13.xcframework.zip",
			checksum: "f3fc66199936b1acfdda9dee3916e85770b26ae1df1fa865368282966664f157"
		)
	]
)