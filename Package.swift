...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-2.2.0-rc.1.xcframework.zip",
			checksum: "28dcf9dad115f7ae8330173277b5470bfadca02fdae7f86fe61b6889be28bd59"
		)
	]
)