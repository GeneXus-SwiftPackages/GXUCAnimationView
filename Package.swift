...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.1.xcframework.zip",
			checksum: "fc6f189be1e1930aacdc84c6b53dbc5b2434720ebe2fca2f51b1561642c02bcc"
		)
	]
)