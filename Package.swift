...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.0.0-beta.51.xcframework.zip",
			checksum: "d212313817115207a48a33e3039aa5385e45d06ebd45e1cc2ddd3f6edd5ce16f"
		)
	]
)