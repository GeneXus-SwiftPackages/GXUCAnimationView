...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.22.xcframework.zip",
			checksum: "31a823709f7689742f4a1c59df21cf98676c1bd90167322135aa017511e784de"
		)
	]
)