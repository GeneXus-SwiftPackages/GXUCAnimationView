...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.11.xcframework.zip",
			checksum: "55a414061efc8eee1e864c28de67a27226dabf5d6d58debfb0b03f4625cc3eb0"
		)
	]
)