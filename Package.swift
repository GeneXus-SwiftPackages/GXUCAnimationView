...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.29.xcframework.zip",
			checksum: "02ec64a2583c5f6bf608390726fe1576d9c01d6fd175311fbe272a20a4b40ad7"
		)
	]
)