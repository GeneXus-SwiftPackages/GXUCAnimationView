...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.23.xcframework.zip",
			checksum: "670aca72a853ccf71e93f6bc07c303a9969c49314e84a9816b7b5b663faf6fda"
		)
	]
)