...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.21.xcframework.zip",
			checksum: "4edbeb38548497a240727b7a9046dcf91c8bac288e3f2b10af460755797b9fe4"
		)
	]
)