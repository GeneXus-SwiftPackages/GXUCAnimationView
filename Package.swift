...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.9.xcframework.zip",
			checksum: "e73772226689efb4db848d733d2eb1dc9bc5b91ef452f1019075113455a6e819"
		)
	]
)