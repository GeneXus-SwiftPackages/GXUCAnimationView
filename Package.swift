...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.22.xcframework.zip",
			checksum: "44dea88545a950c2cf2c7663b77abebba6195b82696c6203e5ec7779f7066c9e"
		)
	]
)