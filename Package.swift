...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.14.xcframework.zip",
			checksum: "2e3482e9dd23eb4e7e999583473817c178fa293fd8041db10939cf6da31895ae"
		)
	]
)