...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.4.30.xcframework.zip",
			checksum: "c928b8ec5a7fd623834a2810a06b167e8d8c193cdcb30962a76f258926634f41"
		)
	]
)