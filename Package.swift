...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.14.xcframework.zip",
			checksum: "d1fa15a8941048ff399fd76f216cf73ca235b463410f51a8492d10bd0d971f1b"
		)
	]
)