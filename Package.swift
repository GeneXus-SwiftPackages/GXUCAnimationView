...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.6.0-beta.2.xcframework.zip",
			checksum: "ad80f7732799384677c7969be890cde46ea9dfe74c297c304a4aad683ba29e77"
		)
	]
)