...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.38.xcframework.zip",
			checksum: "9e641846bb5b907c181609d8fa3ab8e098dc6b9c2faf9a5cc19024fb55b73b79"
		)
	]
)