...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.8.xcframework.zip",
			checksum: "54f56ff55c804573049b25841ef5df15c1fe5dba754debf6058140ebbfd4b32e"
		)
	]
)