...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.2.0-rc.37.xcframework.zip",
			checksum: "838d1030f3ff15aa7d7f948e09718f1dfc81277ad8e6229f0d9f924edaf19ea9"
		)
	]
)