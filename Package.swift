...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.2.0-rc.10.xcframework.zip",
			checksum: "a714f54f4a6bf9206f0aa3373b9eecf7a759f4356875f00e97111f58027c0f95"
		)
	]
)