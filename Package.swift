...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.21.xcframework.zip",
			checksum: "e24cc1470234ea557ecf68dfc2b7e01db068855d58c316fedd17ef4aa96de292"
		)
	]
)