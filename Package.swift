...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.2.0-rc.13.xcframework.zip",
			checksum: "664e08d284da812f65d5e089de0870ac3bc3343b9735ba1bd061668b5d2b4f02"
		)
	]
)