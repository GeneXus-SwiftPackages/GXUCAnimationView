...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.21.xcframework.zip",
			checksum: "f0bf222bef9c8189586e072d5f76ea2ffd117011e8eab163de15583f0eb9fa70"
		)
	]
)