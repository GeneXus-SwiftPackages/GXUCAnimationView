...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.16.xcframework.zip",
			checksum: "70cc671347cfb4a73f175f057c8bd2a535d541f42f7a3dcf1dff9610916a1122"
		)
	]
)