...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.5.xcframework.zip",
			checksum: "a730de5bac070187f9ff2b379daee1adfd16f42812119c52ab8451fae5d8ffa2"
		)
	]
)