...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.11.xcframework.zip",
			checksum: "05c79ae9143dfb28ba4a2b8349a5c1bc97b37e59776f93811e2787bbc1bd2aac"
		)
	]
)