...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.1.0-rc.22.xcframework.zip",
			checksum: "f5cf9bb9ffa3d6b4c19777dff3dafe1ea8a309b8392738f72e746733190b9282"
		)
	]
)