...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-2.0.0-rc.32.xcframework.zip",
			checksum: "144f2a0e1b8cc6a4d2e6c9b1f6cdba6098356426d1430f2ebe1547e6eaafb187"
		)
	]
)