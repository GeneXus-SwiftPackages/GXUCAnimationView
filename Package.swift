...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.17.xcframework.zip",
			checksum: "c23b904a5e82ac25caaa75d32a46ff9db6b55c512c0a2888ec882f24ed1705ac"
		)
	]
)