...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.5.xcframework.zip",
			checksum: "421cf1c67598d6d715564d82069a48c0f4744e00556b7f8e38b76ca2a0fd2c9d"
		)
	]
)