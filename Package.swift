...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.16.xcframework.zip",
			checksum: "f26aa3106ae159baa4fe6d266f81cf87244554e46ba23751c39c0e28454645b7"
		)
	]
)