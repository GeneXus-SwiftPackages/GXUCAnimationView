...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.9.xcframework.zip",
			checksum: "fa4500ad98eb93b77c6bc98dfafabd59b462389019e12addd4b797c7f3a103c7"
		)
	]
)