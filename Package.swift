...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-3.1.5.xcframework.zip",
			checksum: "375dfe4d144a31278f6bce74b71ba7fa15873113e24395a80222307dc8e7d845"
		)
	]
)