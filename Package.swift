...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.25.xcframework.zip",
			checksum: "f03881fa47f52b1faf67d25f37f27c772538a6b5aac4ffd33364137a88adc35a"
		)
	]
)