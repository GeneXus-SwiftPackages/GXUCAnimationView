...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-3.0.7.xcframework.zip",
			checksum: "9dede7757982cc87847422773495ccc5edfdee3adde2418599ba6e431dc54eb9"
		)
	]
)