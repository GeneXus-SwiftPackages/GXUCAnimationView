...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.20.xcframework.zip",
			checksum: "41ec8c62b802315a58c315adbb71c305738e05aa7407edd605d4591d0fe81153"
		)
	]
)