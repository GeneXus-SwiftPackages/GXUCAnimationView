...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.0.5.xcframework.zip",
			checksum: "177569c98e13be388190f0ca77f36b250bc5de7e93703ba31cd8818cc8b8f7b6"
		)
	]
)