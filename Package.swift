...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.28.xcframework.zip",
			checksum: "2070a2101d04adc8ce10e574613c0d274f4f8e7efe47bca56a98f828b22fdd52"
		)
	]
)