...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.6.0-beta.4.xcframework.zip",
			checksum: "32a493ccbe2f817731dbad12f711da262dff1e6473dce461eede3a8d28db7713"
		)
	]
)