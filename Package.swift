...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.0.0-beta.44.xcframework.zip",
			checksum: "1e0769de914246459c7b51b44108adfaa08a1af89bd856d4a30e32acaa369290"
		)
	]
)