...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.1.0-rc.4.xcframework.zip",
			checksum: "09de6ec939e27342463d1d2454e7f38767c68dc50d75299fe9d0726f8f2c6cca"
		)
	]
)