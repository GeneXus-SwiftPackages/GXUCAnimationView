...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.5.xcframework.zip",
			checksum: "e974a25d3e293ec7efefcb8f9c1dd4ef306d613de54954424fdc4617562a019c"
		)
	]
)