...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.5.12.xcframework.zip",
			checksum: "1f55d002656cf0f67d28562362fd19d92d68dcd8f323825dd2a37cae48268e6f"
		)
	]
)