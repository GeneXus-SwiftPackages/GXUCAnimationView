...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.6.0-beta.1.xcframework.zip",
			checksum: "dfe0149f1acecfec398d5c03112ddbb1a48c9bcd8b435f77699c551589058f2f"
		)
	]
)