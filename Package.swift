...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.19.xcframework.zip",
			checksum: "cf8a2e241e40953858de4f89838120aa1abf354d78c821e91cad7ec2040de0c1"
		)
	]
)