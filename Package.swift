...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.4.xcframework.zip",
			checksum: "3cd8a9222c7675435c040f074394e3d454f040a4e516f342ef9b132e703dded3"
		)
	]
)