...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-5.0.0-rc.1.xcframework.zip",
			checksum: "dbd388d0c31e0d77af6a4a780649c3a0450aafa098c2c2ff4a5c025ab53e2346"
		)
	]
)