...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.4.xcframework.zip",
			checksum: "a3ad7dcbd426739cef3305a2e919c877a91050399a60e1713e2675c71f926a3d"
		)
	]
)