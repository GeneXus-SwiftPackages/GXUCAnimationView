...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.10.xcframework.zip",
			checksum: "8bd186608be3e4a8affc79572c0240dad90eb92395e67d39dc2b9879c10947f5"
		)
	]
)