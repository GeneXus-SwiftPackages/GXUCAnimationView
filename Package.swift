...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.12.xcframework.zip",
			checksum: "938011e41d8803baa8f846ec44be791047c4e8270117e349cfdc1b6366ebda06"
		)
	]
)