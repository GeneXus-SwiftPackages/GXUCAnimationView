...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.7.xcframework.zip",
			checksum: "125fb28cde774a9c198f3414ae8524a3b9e51fbb8893d6b78b8de83026b460ff"
		)
	]
)