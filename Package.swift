...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.36.xcframework.zip",
			checksum: "9fe3939a9054fc2244249f66762f679c1e61ddb996de13f789b1978e11d51c43"
		)
	]
)