...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.21.xcframework.zip",
			checksum: "414e688f18a7776d6b5d477188c8102a6aebeed26d701d072db4059fb2c7a327"
		)
	]
)