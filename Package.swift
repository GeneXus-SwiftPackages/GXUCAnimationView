...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.11.xcframework.zip",
			checksum: "d6f01f0d0e1f3fddb1c7982217b5aeba83d32317c0b20447a770a2ce00cdb973"
		)
	]
)