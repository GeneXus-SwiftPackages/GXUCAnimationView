...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "35579f5e3d5a0785a707f1faefa929dcfebaf17a34cc3942dc33d7969a19d2c5"
		)
	]
)