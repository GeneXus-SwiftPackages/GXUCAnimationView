...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.13.xcframework.zip",
			checksum: "f0de16b5631137b0c85d82f84b4d0fcfb244dc76e1d7257b3f791fe8d02c948f"
		)
	]
)