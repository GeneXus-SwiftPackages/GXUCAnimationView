...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.12.xcframework.zip",
			checksum: "cf4f8f5d6769b605528fd2ebb14a7baaea109859c33b257a756bb7faf00076b0"
		)
	]
)