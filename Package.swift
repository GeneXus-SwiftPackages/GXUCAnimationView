...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.24.xcframework.zip",
			checksum: "1b408708de4ce1d3c2adcb9764e66a96bca28b50a1ab4d03bda246b6f2a82b99"
		)
	]
)