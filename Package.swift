...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.1.0-rc.14.xcframework.zip",
			checksum: "68f9b17fa91eccd6988e258698d348b5aea1868102530f6a75df6f989da44fe3"
		)
	]
)