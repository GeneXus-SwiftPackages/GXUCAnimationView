...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.19.xcframework.zip",
			checksum: "47c9c73f7bea4bc42d42117c30602b72d82c9bb3f30c1d7adc55747527c747b8"
		)
	]
)