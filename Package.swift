...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.24.xcframework.zip",
			checksum: "ed0b7ed12f2ca70950bb8c2bd1d0ee0d3e4d21f57250b73730c6e9b0edfdd580"
		)
	]
)