...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.5.0-rc.28.xcframework.zip",
			checksum: "b4eb05885e510c5934411bbf00c5a46f924b5ced4c064191a8a8ecdf72d3dc0e"
		)
	]
)