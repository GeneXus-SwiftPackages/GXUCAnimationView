...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.27.xcframework.zip",
			checksum: "7ec88ff49ac95c08089f9d41ac8563be6e931fb4a831b8f9810c8060e7b9046e"
		)
	]
)