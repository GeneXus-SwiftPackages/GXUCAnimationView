...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.17.xcframework.zip",
			checksum: "355d7f0540837152bf9c645206a4a20a7ef4fc5926136ec23800c517afbd1989"
		)
	]
)