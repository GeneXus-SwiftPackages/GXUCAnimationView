...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.38.xcframework.zip",
			checksum: "149c5163bf0e702eb5fffe8b0cd9074228c8ebec15d03b3a17c81fd7eaa78b33"
		)
	]
)