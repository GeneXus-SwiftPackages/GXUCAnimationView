...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.29.xcframework.zip",
			checksum: "e0790283a2ce0bb215800cce41ec2f203fb7e8b9ae1313c74b1e64d334dc70a2"
		)
	]
)