...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.25.xcframework.zip",
			checksum: "7c45d2a3520aeb76dead20f20e4e2d4489b82e66a7d64b7007cf13e839152f48"
		)
	]
)