...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.23.xcframework.zip",
			checksum: "235b2ce344d7793b72d963fa71d0ed031d95fd61319c0fdd68d576fa198057d5"
		)
	]
)