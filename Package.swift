...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.3.xcframework.zip",
			checksum: "2536fffcf52f82d122721a6ee4f9a2421c33be1481d72d3ba6286228ef88620c"
		)
	]
)