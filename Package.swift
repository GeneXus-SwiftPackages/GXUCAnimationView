...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-2.1.0-rc.23.xcframework.zip",
			checksum: "a56ebeaed0ce8c4afe1f4ab5f133b3d2740ff96d7293de2ded9c23db41fb052e"
		)
	]
)