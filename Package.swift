...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.3.xcframework.zip",
			checksum: "4bb8cfe7045b7ccfec1a494c1302777b779c6833a33d73041d94fe67f2b16cc0"
		)
	]
)