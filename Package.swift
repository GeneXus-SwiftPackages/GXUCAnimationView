...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.21.xcframework.zip",
			checksum: "5f89db2919d3f26ec02b7028605ed68798649ffd687be260291ed5d714dbcce5"
		)
	]
)