...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.1.5.xcframework.zip",
			checksum: "b1c57da666d930c8fce61bf7501c1ab06978ab4272a468f81e9c4bcf2c441735"
		)
	]
)