...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.4.xcframework.zip",
			checksum: "3257a03c7cd894caa750dd8339a4356da0f995d02dbea7d2bdc06c5c2ad93abf"
		)
	]
)