...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.9.xcframework.zip",
			checksum: "648ca32b26da7b99c118776b8711e4b609bb8352078c859b694295f2d6d65032"
		)
	]
)