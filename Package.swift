...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.1.0-rc.1.xcframework.zip",
			checksum: "46fb0f0a0841d1738ef2642d1d7e04e7904fcdf08a8328dccb0ae736ef0ef7da"
		)
	]
)