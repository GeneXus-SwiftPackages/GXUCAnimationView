...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.17.xcframework.zip",
			checksum: "83a31a46ee01d36c224ba364d2c8dbed4afe0338d5bff2f384d70f19c5d18d13"
		)
	]
)