...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.15.xcframework.zip",
			checksum: "6c727e76a2f52d0182c727f9bc2d5fc2e55bd8368b12fd4e4b2261a80062778b"
		)
	]
)