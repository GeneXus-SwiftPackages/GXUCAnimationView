...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.3.xcframework.zip",
			checksum: "b8d3c48c8e0dbdba27e4afbbc5794aa0e1fb5c285fa76a849411f0379f301223"
		)
	]
)