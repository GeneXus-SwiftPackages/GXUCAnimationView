...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.18.xcframework.zip",
			checksum: "b8cf092457893329b8a88e55f6e12688446aac8d31966d1c5415353c3f10f83c"
		)
	]
)