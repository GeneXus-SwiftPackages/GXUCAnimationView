...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.26.xcframework.zip",
			checksum: "29ba154cedb3700e4ef090a6e74faf0d4710d6e4cd1397120601225f32405020"
		)
	]
)