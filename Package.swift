...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.1.0-rc.8.xcframework.zip",
			checksum: "a3e03a56d905380ed64977a4f632721ba5fe1aaf0b247310fa0e558ff4db6b02"
		)
	]
)