...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.2.0-rc.36.xcframework.zip",
			checksum: "a85251e1b015fb4c8dc7213a5569bc190b6437f18eea879ad80e66eeb41d1774"
		)
	]
)