...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.0.8.xcframework.zip",
			checksum: "f3fbcba025a9bbf7bf31d251f6666ceafbb05e79d28158db0c790b7c443c11bc"
		)
	]
)