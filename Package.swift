...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.13.xcframework.zip",
			checksum: "8b50ef588dc13cba94789c0fa4412d053a4fc93ceb20788b7cbcf954dad41025"
		)
	]
)