...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.26.xcframework.zip",
			checksum: "b58d241c30d3fa9a9896daedaf2fdecf81c684cad0b6288b924e2e553dec256a"
		)
	]
)