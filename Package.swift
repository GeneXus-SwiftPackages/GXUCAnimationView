...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.15.xcframework.zip",
			checksum: "bff6a6686be2062e60c438f6bce404ad81efed10950359a7cd1b86b9775dcd9b"
		)
	]
)