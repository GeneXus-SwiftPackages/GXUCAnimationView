...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.6.xcframework.zip",
			checksum: "a3cab29cf8aa50284acba2e67df1979a08f754f8e925e9fda5727f46f59b88c6"
		)
	]
)