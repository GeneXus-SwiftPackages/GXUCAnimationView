...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.0.9.xcframework.zip",
			checksum: "cc4723af016cc6fcab95d2e59dc0e547bc1019b3a5eeb784b186a9270d97e298"
		)
	]
)