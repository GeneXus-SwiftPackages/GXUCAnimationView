...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.2.0-rc.15.xcframework.zip",
			checksum: "e3483ce4d3744c6ab40457e1bf22ce4273538310b3ceded69c1dab161c91b44b"
		)
	]
)