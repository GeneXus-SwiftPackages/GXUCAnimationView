...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.9.xcframework.zip",
			checksum: "69ca47992a03237d75895615a442545308f50275ed7ab3f9b0dfb95313d35ab7"
		)
	]
)