...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.14.xcframework.zip",
			checksum: "d6e23f468a22e309d824acec099af54a406a8e1f0e1677ad1a48fe776a6ca694"
		)
	]
)