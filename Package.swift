...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.18.xcframework.zip",
			checksum: "6614485f71d31569ef0ded0cf3a6fd85ab0ba00bcd498fe63f7540418b027781"
		)
	]
)