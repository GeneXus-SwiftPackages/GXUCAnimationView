...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.0.0.xcframework.zip",
			checksum: "bb4386f5a5d63f5130b675ac1cddc7f01af1f7ac3863e74e6f440d8e3105f066"
		)
	]
)