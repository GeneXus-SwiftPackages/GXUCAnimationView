...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.20.xcframework.zip",
			checksum: "53a5a6326b31b2e42ebe959bebe35d634e4f01e199e99193ca2da7ea42dc8358"
		)
	]
)