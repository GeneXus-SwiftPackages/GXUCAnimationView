...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-2.1.0.xcframework.zip",
			checksum: "7721ed11ba79d2accbba8be00cda96391af1ba290037568209388ce2efed05ec"
		)
	]
)