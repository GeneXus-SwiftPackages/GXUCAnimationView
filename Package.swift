...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.10.xcframework.zip",
			checksum: "fd5224e903d22984f62c28794ce323771766bbde91045ab432d4f4b46d65babd"
		)
	]
)