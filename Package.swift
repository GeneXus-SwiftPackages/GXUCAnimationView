...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.2.0-rc.12.xcframework.zip",
			checksum: "f7bf28fcb806d6aefa49a07a0904249673f692a3101b71788763524278e9b433"
		)
	]
)