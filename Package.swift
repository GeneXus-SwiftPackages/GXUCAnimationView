...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.31.xcframework.zip",
			checksum: "79855840bc7757bc74b4066e970b0decd69cad87b9e4ea79658a5add26930b35"
		)
	]
)