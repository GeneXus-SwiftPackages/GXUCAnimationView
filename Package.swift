...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.28.xcframework.zip",
			checksum: "70beb8f192cbcf1e953f56181c6b0b593afe24dcc9621a39ff2ab60071d3d511"
		)
	]
)