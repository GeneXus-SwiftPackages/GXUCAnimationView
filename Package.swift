...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.31.xcframework.zip",
			checksum: "4702195c27221f67e0e5245938ab01bc0afe24a052a78bd807be7b2996d4ff8c"
		)
	]
)