...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.1.0-beta.794.xcframework.zip",
			checksum: "af0bd45445f19c1e32b23266164fbd259c3ae06053f5a02df2c9c969629f22d0"
		)
	]
)