...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.16.xcframework.zip",
			checksum: "073dd77fb0339aa3c711a6e864914821ee4ec0d5ca202a0e614886a43003c66f"
		)
	]
)