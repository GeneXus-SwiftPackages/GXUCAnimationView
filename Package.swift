...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.2.0-rc.9.xcframework.zip",
			checksum: "c17af1e826958459b8e6ca7c9076dcb0395d38d6808309982a4b06089dc35b33"
		)
	]
)