...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.1.0-rc.8.xcframework.zip",
			checksum: "130787a31f9bc8d5d5cd3b1a20fa83daf25d887e6f878ae85dafe1c2ea7bcb82"
		)
	]
)