...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.11.xcframework.zip",
			checksum: "50923a51ab6a823f3e8887848b7691a345d52e96387f8a5f73612aef7da89a7a"
		)
	]
)