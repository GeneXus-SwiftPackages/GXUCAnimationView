...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-5.0.0-beta.4.xcframework.zip",
			checksum: "a54a9214e11d17b1271f37a4ee39833f30e7f01c8fa148f0533b4c159d776a20"
		)
	]
)