...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.1.0-rc.3.xcframework.zip",
			checksum: "03040d7f7d2e40614c325143411e36d22ab84612e6bc0e8deadfc0f9a5f3c765"
		)
	]
)