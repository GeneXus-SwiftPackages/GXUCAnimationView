...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.1.0-beta.12.xcframework.zip",
			checksum: "fdd3f5c814f9c9c8de982de9a474c0a239f20693f9d8893b74cc35a81573e145"
		)
	]
)