...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.3.0.xcframework.zip",
			checksum: "3a2ffd59336798225697ff9df1c25d681bce9f4cfa6ae140de1fb96ab4ac3b44"
		)
	]
)