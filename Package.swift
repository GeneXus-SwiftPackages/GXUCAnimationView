...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.14.xcframework.zip",
			checksum: "76f99fe1bb62a302f210055b6496b26c6e33a7136f7ea4c7731d1d4882bd058d"
		)
	]
)