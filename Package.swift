...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.12.xcframework.zip",
			checksum: "99953047a933a90ba057b45323f089f25ec69648b9927f54c9936d71e9531554"
		)
	]
)