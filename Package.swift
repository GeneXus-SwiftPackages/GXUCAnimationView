...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.16.xcframework.zip",
			checksum: "3fbf0b2c8afe24086c4b926c8ea9b495109b9e56f694d484d4145152b42f224f"
		)
	]
)