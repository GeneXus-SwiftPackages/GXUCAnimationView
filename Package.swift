...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.9.xcframework.zip",
			checksum: "44f39003c6aaa01761dd69f8b6a51e068228c6f70dac90e42968505a939ded10"
		)
	]
)