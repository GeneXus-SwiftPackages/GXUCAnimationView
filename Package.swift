...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.3.3.xcframework.zip",
			checksum: "b8fe1cdbf2f56680913a4a4410610087091b922438bb9e4d9408dd3c6c509677"
		)
	]
)