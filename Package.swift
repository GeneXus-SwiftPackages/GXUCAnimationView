...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.0.7.xcframework.zip",
			checksum: "faf6088c0cffc51ae70efe33efed6f2916ceb09441081dca7f424f7381ab6f49"
		)
	]
)