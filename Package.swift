...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.21.xcframework.zip",
			checksum: "1f4983c7e8cdc844cfb71c6f07c3cbc5ac17e245f5c1aa9080b2e692b22b1110"
		)
	]
)