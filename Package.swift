...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.6.0-beta.0.xcframework.zip",
			checksum: "b6c7845afd97778578727dfb0dc5a63c0a55d7bce511b53bc015e21d114905a5"
		)
	]
)