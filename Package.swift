...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.0.0-beta.20230630204809.xcframework.zip",
			checksum: "f2b7bf16f1061ebb774a01b3c99aa7346041cb07953ae94a3cf7d3bf87cac066"
		)
	]
)