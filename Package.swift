...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.25.xcframework.zip",
			checksum: "4126821ed6cf8d790db73de7880d92c79ea3af040bbc89f68bb5d4908e7a55b9"
		)
	]
)