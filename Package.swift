...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.4.xcframework.zip",
			checksum: "3f2ed136335423516c8fa74d435bf7c858bc95a74627094082961e26a6802fa2"
		)
	]
)