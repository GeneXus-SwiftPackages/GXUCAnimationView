...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.3.xcframework.zip",
			checksum: "c3c7a8bfabeaacb61c20b3978914870481e11f3aaea503113fca39118395ad48"
		)
	]
)