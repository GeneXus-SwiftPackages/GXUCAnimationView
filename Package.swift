...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.2.0-rc.0.xcframework.zip",
			checksum: "441dfaf4c83da7c0ccd78b0aa7127d497c9079038179bd21e55b414fe77010c4"
		)
	]
)