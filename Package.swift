...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.39.xcframework.zip",
			checksum: "9253f1d3a55ece9a1de32ff85744039c102ac561e5a41b8321c93d2f89b2aa37"
		)
	]
)