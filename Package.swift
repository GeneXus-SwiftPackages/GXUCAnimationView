...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.1.0-beta.795.xcframework.zip",
			checksum: "c29494a1ce33cb65d406fb7c7eae6a633149e386df9626fe0eebe0e3605c20fd"
		)
	]
)