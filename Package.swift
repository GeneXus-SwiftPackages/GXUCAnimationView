...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.25.xcframework.zip",
			checksum: "a01fa24d7c9a9a5e13d9d2b1a838494a86705caf245dc3867800884121b124c4"
		)
	]
)