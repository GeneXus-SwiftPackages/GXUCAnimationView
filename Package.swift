...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.10.xcframework.zip",
			checksum: "dac99e78a4d907bac6b0de4bd47feb3d7f6d696874b396aa79ffc8a5348b76ff"
		)
	]
)