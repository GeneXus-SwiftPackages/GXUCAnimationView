...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.1.0-beta.10.xcframework.zip",
			checksum: "f3603692c8c3c429b173c1cd6422f68289858ef2498ba413d235578cfe18bbb2"
		)
	]
)