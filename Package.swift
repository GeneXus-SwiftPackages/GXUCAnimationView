...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.7.xcframework.zip",
			checksum: "b915094a651f1aa0f5e309632f64ef9c25b39de539e7e2661826752564faaf72"
		)
	]
)