...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.27.xcframework.zip",
			checksum: "19307cc6e352cfdf04ddefefe725f685855aa4f1c9ce90f6b9018f2bb390b22a"
		)
	]
)