...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.17.xcframework.zip",
			checksum: "33e8642fedf535807df1ab39fb3adbac04f91614f9e79809f0768ccb573d4720"
		)
	]
)