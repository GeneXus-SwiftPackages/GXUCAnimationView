...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.17.xcframework.zip",
			checksum: "5a99a83c7ac964a94a8b2bfeaadd4b9b4f8e5aa9d30ec303c9ececcb6bf46627"
		)
	]
)