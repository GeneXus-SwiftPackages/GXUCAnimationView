...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.17.xcframework.zip",
			checksum: "f06f0beda1a89a9f8f900e7b1a75307536d510d9997c9bd576bbd0e6e0386abb"
		)
	]
)