...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.22.xcframework.zip",
			checksum: "43530b706284c622cfc52c8a0c70114166859142f2856a42c1b17651819ddc12"
		)
	]
)