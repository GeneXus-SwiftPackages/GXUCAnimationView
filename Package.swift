...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.1.xcframework.zip",
			checksum: "85b1dbafab49332b9f37fcab8262328658d9213500204fc9636beb2e6b11b9e4"
		)
	]
)