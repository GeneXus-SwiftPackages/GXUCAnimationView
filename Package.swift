...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.24.xcframework.zip",
			checksum: "3994b8c1673d8fbc45302af4d6ed5ffb7adc6d8ed6740e22b6b0e93d9d9210a0"
		)
	]
)