...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.34.xcframework.zip",
			checksum: "a8862eee3d61fe16d81962b89bf704368da84cfc4f11d83fb537076a50ec890f"
		)
	]
)