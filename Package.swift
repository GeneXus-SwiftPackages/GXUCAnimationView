...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.20.xcframework.zip",
			checksum: "f9e2973888ae9200f909ccf32c3039012bf39ec80153d399c2fc55bbf033a1b9"
		)
	]
)