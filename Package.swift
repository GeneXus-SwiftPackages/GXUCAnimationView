...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.24.xcframework.zip",
			checksum: "4d0a031691eac15e625c7a41649dbeb7b6efb6d1c2320211cd24f0fe47302b3d"
		)
	]
)