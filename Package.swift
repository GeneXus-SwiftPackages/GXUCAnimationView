...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.31.xcframework.zip",
			checksum: "911be0d3a493bfec78294deb611d95b54a108a1f3f5e9994da0accc857a0827a"
		)
	]
)