...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.2.xcframework.zip",
			checksum: "ffe2e49cd7aab5ca4c5d3b33a9917e8fd287979d44ac810cdec4a93f502ca02f"
		)
	]
)