...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.13.xcframework.zip",
			checksum: "e5bd7d9d9b3a7eb8b45ce6e81887833fb760523e6619c6df2ed0441a48f5b391"
		)
	]
)