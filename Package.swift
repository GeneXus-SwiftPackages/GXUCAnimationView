...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.36.xcframework.zip",
			checksum: "2eea7921593000ca4e9e1832e7f0252f7bd389c0f0be78c9118e5f70ad7f9ef8"
		)
	]
)