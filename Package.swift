...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.24.xcframework.zip",
			checksum: "de728b02a393e7e3a781d154d057d136c446954177619a3eff6f833598e0fb9c"
		)
	]
)