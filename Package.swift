...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-2.0.0-rc.34.xcframework.zip",
			checksum: "9c529eeca7d14a27b2fa8fad9561bde2328912ff2cf7e83fcb1817099491fe9b"
		)
	]
)