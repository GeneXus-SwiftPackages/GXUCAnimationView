...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.30.xcframework.zip",
			checksum: "94b77a44db36ded6c35191f19eda168c6d7d56a6b8d9de30791e696f6a02d8cd"
		)
	]
)