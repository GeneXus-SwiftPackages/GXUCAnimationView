...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.11.xcframework.zip",
			checksum: "2f5e542f243bfaf45c5cdedd9d5be84ce49ba7f40034bc38d7605ca4c765b9c1"
		)
	]
)