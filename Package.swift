...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.1.xcframework.zip",
			checksum: "9deea133fc366b77e0412772c4a4f5a0f1ae65897b25646101e5acd6ede99ace"
		)
	]
)