...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.0.0-beta.48.xcframework.zip",
			checksum: "a98ca2b48232b4178d954fd5a4c15e2f62c098583e3560cf7a2c5ea75dd56e41"
		)
	]
)