...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-3.0.3.xcframework.zip",
			checksum: "d33271e9bd72488951086cfa6d40166cf74e4b34692285a9bbdc9fcd9dc4db63"
		)
	]
)