...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.2.0-rc.34.xcframework.zip",
			checksum: "da10962b90ee4516a17759872a42b57f9181a6d092e24876d796fca068e5c125"
		)
	]
)