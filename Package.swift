...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.2.xcframework.zip",
			checksum: "b6b8fcc7e389f86946a2aa3e05d5df6bca498d3c81d78f87c90b0888a5c81b43"
		)
	]
)