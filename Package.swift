...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.4.xcframework.zip",
			checksum: "502aaaa81b66f2a3363f3a10a3430419088c8c9f4aec9f7a65fd69b2444da436"
		)
	]
)