...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.8.xcframework.zip",
			checksum: "f74fc40e033f383a6079ab7d319a5560c930549bbe754bb8634e13da14d08b24"
		)
	]
)