...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.11.xcframework.zip",
			checksum: "366a443a0a93d0c8e118c20028cc86d2fe6bdad6fe5ad03f928fadac1357eef2"
		)
	]
)