...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.2.0-rc.0.xcframework.zip",
			checksum: "b025a58b6cb218e1b2b124e3c4d428e52d6ba173a5226751af6c977cf66a1025"
		)
	]
)