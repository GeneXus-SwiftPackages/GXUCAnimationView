...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.11.xcframework.zip",
			checksum: "3c11caa1c0deb14a09ceea65582c1dc1536232db5faa989b3564ccf4b58ee050"
		)
	]
)