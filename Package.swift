...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.7.xcframework.zip",
			checksum: "6636ade7ea9bb0140e189f7d38e0623fe3c64f450e602f104bac1eaee23ae5ed"
		)
	]
)