...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.1.0-beta.8.xcframework.zip",
			checksum: "3c2da47a2e81eba201fe0b66402edaecb189d5eaa9c9ab0decb89bf10f57b7fb"
		)
	]
)