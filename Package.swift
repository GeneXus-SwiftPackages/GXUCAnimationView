...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.15.xcframework.zip",
			checksum: "3aee7751103b50bdbbc64aa9e1f429569f248ba81a29e8a04986086982919480"
		)
	]
)