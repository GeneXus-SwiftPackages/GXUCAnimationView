...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.32.xcframework.zip",
			checksum: "b20b960c039ca3faa072470e9b2e8cf1c9880d8a1dd757dc5cf626a272a5e06d"
		)
	]
)