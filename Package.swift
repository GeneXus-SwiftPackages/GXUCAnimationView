...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.33.xcframework.zip",
			checksum: "31b1939aa1da1fa34579d2d37bd39bcf746002438b7c82e32177065419713181"
		)
	]
)