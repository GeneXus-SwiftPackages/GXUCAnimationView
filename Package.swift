...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.20.xcframework.zip",
			checksum: "d672ef34804503ab62b2e96ba6958f22981a9e82005f3b18e747b553cc4e6b7b"
		)
	]
)