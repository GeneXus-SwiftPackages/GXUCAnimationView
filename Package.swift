...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.0.0-beta.20230721123914.xcframework.zip",
			checksum: "07e8251a14d655b93120d2676d0bdb27d4b93fa7c23275dc1a789e3831a12cde"
		)
	]
)