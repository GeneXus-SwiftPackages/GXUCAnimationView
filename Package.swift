...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.7.xcframework.zip",
			checksum: "691a3085b9152eabf72fee5dd5234967d718325fdbd1dc8d4c5c7026e5f663e0"
		)
	]
)