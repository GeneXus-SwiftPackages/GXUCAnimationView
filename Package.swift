...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-2.1.3.xcframework.zip",
			checksum: "e234093f0cbd16d7e5ee8ffca0f24bdb28619bf5fc3887d58971cc39d01a5eb5"
		)
	]
)