...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.6.xcframework.zip",
			checksum: "b20e2b1ba9ab03a88e85000973b68bc3a4d4969e1f8f565a02512faa5e584aac"
		)
	]
)