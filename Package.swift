...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.5.0-rc.2.xcframework.zip",
			checksum: "c5665be4d879990b170cf99161afa3c1b4b1c33ad0fbb9cb790128b76a862040"
		)
	]
)