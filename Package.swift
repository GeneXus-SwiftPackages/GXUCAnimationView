...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.17.xcframework.zip",
			checksum: "a3304252afb47fee907660bf16a4f7722fdbce213e3ba471431ae855bef9d692"
		)
	]
)