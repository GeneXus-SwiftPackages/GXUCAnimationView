...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.27.xcframework.zip",
			checksum: "afdf2c9780790b432897376b0b721c7963661204c897a4a668a3d517023aaaf8"
		)
	]
)