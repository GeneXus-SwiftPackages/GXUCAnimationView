...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.8.xcframework.zip",
			checksum: "f853e177b3e077e8b1aae78e322c9d379d6bcd407ec11c4eb39c482e57952cdd"
		)
	]
)