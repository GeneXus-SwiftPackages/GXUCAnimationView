...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.19.xcframework.zip",
			checksum: "beb122d164f42964a866fd9d257bf0b333f59c9034e8d0bbdaaa1b6d1a59828c"
		)
	]
)