...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.6.xcframework.zip",
			checksum: "647559dc4f26c7cacfde41a902502631185db2c9949386292466870b89677838"
		)
	]
)