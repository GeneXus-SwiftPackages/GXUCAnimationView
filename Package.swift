...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.1.0-rc.24.xcframework.zip",
			checksum: "76d3e75f5cfb425eb9a36ad741ba0960195ac45d41281a018ae67061ad04089d"
		)
	]
)