...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.1.0-rc.25.xcframework.zip",
			checksum: "8c86cd3034f2ed0debf2c9a3e02989ae6802feba043585c8748d91664ebb6a7e"
		)
	]
)