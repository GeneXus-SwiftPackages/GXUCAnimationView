...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-2.0.0-rc.22.xcframework.zip",
			checksum: "3fc4e002c2636cccff8ee2dfee861a3807508db0fc35f71d782119b67518b426"
		)
	]
)