...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-3.0.4.xcframework.zip",
			checksum: "43ef9565a1682af27552e6c8f9edc2df54a4fe8d2c1aab902232e7bd2153609e"
		)
	]
)