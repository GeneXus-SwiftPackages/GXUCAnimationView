...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.17.xcframework.zip",
			checksum: "0e40e08a48cc1ef423c0efd4798f100578e8bbf60562020e00969bb935e4e233"
		)
	]
)