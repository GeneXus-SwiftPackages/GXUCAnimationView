...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.8.xcframework.zip",
			checksum: "0d352c5a94a7eb406ccd99e158c89586697f45d90583782abe0aad8e60c0e1be"
		)
	]
)