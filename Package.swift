...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.28.xcframework.zip",
			checksum: "78e5a237ce060859b3aa495c7744cbaed5d3f53be3f8b7830107ce812b9fa60c"
		)
	]
)