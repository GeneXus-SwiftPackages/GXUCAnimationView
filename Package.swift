...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.4.xcframework.zip",
			checksum: "41af2757496a261defece09829bef626e0a7a9e5b28a641baa7639c2157e43d6"
		)
	]
)