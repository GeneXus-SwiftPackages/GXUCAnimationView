...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.25.xcframework.zip",
			checksum: "ccfa58142935c5658ea047ebeba1df1c2c3b2516b66d1b6172593c2a97296d97"
		)
	]
)