...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.23.xcframework.zip",
			checksum: "6ab5687be5c3b56785b4c43845fe6fd409ff1d782d94ffa00f345a524ee49a50"
		)
	]
)