...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.1.0-beta.24.xcframework.zip",
			checksum: "17add7560421f9415f2f73e5f5c741acdf61bd843cca8540d6fcb930aff9206b"
		)
	]
)