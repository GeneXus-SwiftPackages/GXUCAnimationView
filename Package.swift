...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.10.xcframework.zip",
			checksum: "d817e57a986fa2f09d3626195366222230af5cf9d63491da8e9309de65210f1c"
		)
	]
)