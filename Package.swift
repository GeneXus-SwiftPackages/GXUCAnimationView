...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.39.xcframework.zip",
			checksum: "4ea54f175c0ea46b239a148fc59833264ef199f729b4ede8a2c75f93b965f05f"
		)
	]
)