...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.1.0.xcframework.zip",
			checksum: "a8e33df565a845e196d83fb45b57f96cd4d78d60c1f7ecd96380fb06f8dba9bb"
		)
	]
)