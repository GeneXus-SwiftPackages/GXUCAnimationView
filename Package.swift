...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.13.xcframework.zip",
			checksum: "4f54007381491342784f31233de272aa580d2689c24ecb094df899c68bcea1cb"
		)
	]
)