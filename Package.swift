...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.35.xcframework.zip",
			checksum: "ca71cd66ffa65c7eef31714ecc5d9a63077c4d2cd4dbb8856cb08ed2ffc41d94"
		)
	]
)