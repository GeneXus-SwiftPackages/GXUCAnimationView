...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.26.xcframework.zip",
			checksum: "26391872b2572d2832b68605c7b4826035b0fd73b39c01dcbf6a2f85713e7fe6"
		)
	]
)