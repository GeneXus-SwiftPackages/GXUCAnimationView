...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.37.xcframework.zip",
			checksum: "1b2155e79b8d2790e6fa0ed08b11d2f0886a516e28300ae2e4208b392be8a0fb"
		)
	]
)