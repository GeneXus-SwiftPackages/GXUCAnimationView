...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "2f0186d08e4e37cdceecfd3c4d9923496847ab691de18116beae7265ef4ec3e9"
		)
	]
)