...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.24.xcframework.zip",
			checksum: "7bb48fa60df34d12abf76a5e1a15e9e3ae705790560c631be7a468a3be9d00a7"
		)
	]
)