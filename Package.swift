...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.4.26.xcframework.zip",
			checksum: "3fba0149f6bb062061c5209dfbbda98f33e724a53dbeb69fdcd7861ccdd906c2"
		)
	]
)