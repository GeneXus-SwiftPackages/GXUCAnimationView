...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.2.xcframework.zip",
			checksum: "22a1d3f4fd32e2cb700423a9bec60c28839132d2f0533158655cf1478e836366"
		)
	]
)