...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.7.xcframework.zip",
			checksum: "a2118a479b7fdd9141432b287412d3560e33dcb79b752fdb586cc3fe750347e9"
		)
	]
)