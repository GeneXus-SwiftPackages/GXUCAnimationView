...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.12.xcframework.zip",
			checksum: "8cecb7b21f041d9eb9d640d2523b1244a38aeca8ff413b68238fc13f99e5c85b"
		)
	]
)