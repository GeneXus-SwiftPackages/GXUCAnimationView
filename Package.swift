...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.1.0-beta.5.xcframework.zip",
			checksum: "812e8975d4af132ce477e8fba3d615bfcb6b1aa1a453588ad38a3acfa93504c7"
		)
	]
)