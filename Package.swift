...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.2.0-rc.20.xcframework.zip",
			checksum: "ecb65f5f9e01fc03ceaafc28125e3aec9050973f00e7a147f2bfd785eab29851"
		)
	]
)