...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.14.xcframework.zip",
			checksum: "a2dab2d0e078fce421737f422749d51fca2623c95d73e961a09b63be8865cbc1"
		)
	]
)