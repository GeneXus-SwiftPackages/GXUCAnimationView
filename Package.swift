...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.16.xcframework.zip",
			checksum: "ae7f80e098f306dd7431419d0783352ec437fecb58492eeceb9b995443463091"
		)
	]
)