...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.22.xcframework.zip",
			checksum: "5dd4429fe634e285480f516684aeef9670a2491ae5967742d43b35698329e7fd"
		)
	]
)