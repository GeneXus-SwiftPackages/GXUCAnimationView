...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.4.xcframework.zip",
			checksum: "169131de0a9020123ae81490ff2bcd31ced5a8b9f8a9293107debf459e685670"
		)
	]
)