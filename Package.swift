...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.0.3.xcframework.zip",
			checksum: "a214f27b3606d4557a90220994262693c184e0ea861f3db904897d5b1e759d03"
		)
	]
)