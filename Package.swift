...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.20.xcframework.zip",
			checksum: "809e42db159677a52bc769d4faa50076409698aa01859ed5bd170e836fc9e7c6"
		)
	]
)