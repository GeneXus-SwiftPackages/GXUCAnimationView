...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.11.xcframework.zip",
			checksum: "a677ea9a8561c2141a2e061472227da34c2789a9a260d75daf70142c09e3b3de"
		)
	]
)