...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.29.xcframework.zip",
			checksum: "6e9e8a76c71616c394f8ee1e8442ab587971d8ee5225fd0ccf5500ed9acef136"
		)
	]
)