...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-2.1.4.xcframework.zip",
			checksum: "97cbce6ea4115f473fd22a8663b5a2ed11186f635ff35ad07a695bc49c40eb55"
		)
	]
)