...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.3.6.xcframework.zip",
			checksum: "ec9564307ed8bd6f68194b5e643b8b197d8a57c2fb9b7c02c24222863177502e"
		)
	]
)