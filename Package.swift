...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.33.xcframework.zip",
			checksum: "32884a0af57ca83c35d1b500d84ca0ecccad93457f0bcab75d9ed2f0f2b8dc6d"
		)
	]
)