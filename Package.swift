...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.16.xcframework.zip",
			checksum: "1bcce72e6fe30d8003448739957023bd66693b5ab2ceb142df35d2f65318eb98"
		)
	]
)