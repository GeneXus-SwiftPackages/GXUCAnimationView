...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.28.xcframework.zip",
			checksum: "b5e11dfbba644e0f18f0a571912c16e8eab93c9722274c5e574ca0edf84ba48d"
		)
	]
)