...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.14.xcframework.zip",
			checksum: "3f996998c0d0de557e08981c9912ce2e5136a492fbbceb9345f5e31f8b63c9c3"
		)
	]
)