...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.0.4.xcframework.zip",
			checksum: "ba1633c0cdbde4ab294f8054f7e3bac92c92f19d02b9a983d4169125afaa9e3f"
		)
	]
)