...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.13.xcframework.zip",
			checksum: "f56b93960749b9a518254c3807d830238df6eaf98149150b849b538cf80a0cd1"
		)
	]
)