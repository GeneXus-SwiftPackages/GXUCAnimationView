...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.1.0-beta.23.xcframework.zip",
			checksum: "2a43625ba9f90d51728da452791d28f66e02841857c57a69515ce8d4a852efbe"
		)
	]
)