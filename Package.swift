...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.32.xcframework.zip",
			checksum: "256c469852b65dae5bad69e723f345ba02d64e754abc0d647d1e82c32ca639da"
		)
	]
)