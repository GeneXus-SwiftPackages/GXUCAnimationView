...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.3.0-rc.7.xcframework.zip",
			checksum: "c9ebf863b7a034806ecb4d331d78224ad6cc34f3ae7bf24800cb5743570acc55"
		)
	]
)