...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.1.0-beta.26.xcframework.zip",
			checksum: "81a2940e9268a0c02bb4335b84fff323269a018ceb58740adfce48e115725de4"
		)
	]
)