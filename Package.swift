...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.13.xcframework.zip",
			checksum: "5c297a3da3250f12333f327327fb521c70c8518227d35d7a78d859c8a3a30242"
		)
	]
)