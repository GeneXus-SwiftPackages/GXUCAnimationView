...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.1.0-beta.15.xcframework.zip",
			checksum: "771f5d4824ae6c2b9124f8371059da40a49c8e1dbb46564b639fcc301c7e7d6b"
		)
	]
)