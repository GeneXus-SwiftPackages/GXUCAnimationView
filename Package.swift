...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.1.xcframework.zip",
			checksum: "a43647a9b798b9f133417f0ce492a51609f54e7a5e1d41ae79c18f878d0984eb"
		)
	]
)