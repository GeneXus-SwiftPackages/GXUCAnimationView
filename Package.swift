...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.34.xcframework.zip",
			checksum: "e187333b056e90e4f9dfa98a2f07a13fea18d615fb67e56336e5bab3a0a1ccca"
		)
	]
)