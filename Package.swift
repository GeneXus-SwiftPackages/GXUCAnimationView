...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.3.0-beta.10.xcframework.zip",
			checksum: "9fad62cb79b838e7f4d596fbf94faf8f48144ee174a2c8b6f4d78d094d9d9dd1"
		)
	]
)