...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.1.0-beta.25.xcframework.zip",
			checksum: "da82cb68b18f6e66b8fe68735f57a9a0952f20ecd4081fd9773a391a7c7bbb65"
		)
	]
)