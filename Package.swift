...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.1.0-beta.7.xcframework.zip",
			checksum: "0fcab876f84bf7c01d719d3a98082a5d87e268feafc53c30e231a0b660f02635"
		)
	]
)