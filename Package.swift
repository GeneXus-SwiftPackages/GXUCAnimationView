...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.41.xcframework.zip",
			checksum: "95e5f7ad07ddd44278d688c748173b8dfced3970df823b8678c7aa756a66008f"
		)
	]
)