...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.5.xcframework.zip",
			checksum: "6d53886e6a7e6fd854376e97052e59ee139f5a79b0770918b9e0f8f55a788e6a"
		)
	]
)