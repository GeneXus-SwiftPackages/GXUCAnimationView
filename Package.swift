...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.2.0-beta.17.xcframework.zip",
			checksum: "3a1d0c97fad1e127e8aca607aa18c5688f7eb692156f74a1fcedebfbd8fc09fe"
		)
	]
)