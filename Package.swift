...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.1.3.xcframework.zip",
			checksum: "2d7af42163328ee8debee640f8edad95d6d256f3262629e6a3581b50a66f2944"
		)
	]
)