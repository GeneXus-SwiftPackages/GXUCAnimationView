...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.41.xcframework.zip",
			checksum: "6caa084a7ec259a05e6b0d2fce271c476aaa52bbdc23055b1dec17529064b1b7"
		)
	]
)