...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.2.0.xcframework.zip",
			checksum: "57597b5ec29679ad76e267ae32f345eb14cd7664703f039f659347b5ec8c7e7f"
		)
	]
)