...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.2.0-rc.29.xcframework.zip",
			checksum: "9fc0565f4012d3f61e5d302c82c6c5cc4dcb377ad471a72958a0b4e8ad0325a6"
		)
	]
)