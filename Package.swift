...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.27.xcframework.zip",
			checksum: "cf3b420f1a750f801288f9184d6930c5728d766ffa04fe13153881809c097051"
		)
	]
)