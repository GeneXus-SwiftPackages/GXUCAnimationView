...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-1.5.11.xcframework.zip",
			checksum: "2ec1dddcee574a8a5cbe2c5bf1e0136bd5f787e5686f1eb5a99e4a5c05a1ae33"
		)
	]
)