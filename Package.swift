...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.19.xcframework.zip",
			checksum: "3af0a182a41c45da108629e805c5bc0b5054e7cb6e37d5f0e6d756893bffccd8"
		)
	]
)