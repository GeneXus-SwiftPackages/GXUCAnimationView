...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.32.xcframework.zip",
			checksum: "1955db6621cafe524f59ea0bf21fc52a537f39d25e303781d6a7168825c7e4a8"
		)
	]
)