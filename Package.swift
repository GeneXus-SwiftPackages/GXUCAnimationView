...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.4.0-beta.5.xcframework.zip",
			checksum: "1051c686615cfccaad41cb333ae2e3d65ea202a5ad07e905a2d541d2d082ce1b"
		)
	]
)