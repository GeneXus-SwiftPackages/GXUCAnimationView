...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.34.xcframework.zip",
			checksum: "3e863bb31ab57400e040e1a61e366a1bf3005e0cbad073ab017d13813dd8ab89"
		)
	]
)