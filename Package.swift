...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.3.0-rc.13.xcframework.zip",
			checksum: "c85727a47cc3211e16e079df19e07a3750cbd6fc64cd185b5ef7ce2b21a2bf00"
		)
	]
)