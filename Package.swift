...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.0.0-rc.0.xcframework.zip",
			checksum: "ff25ebd8b8e44df26a51ffaa24dd4fea8551c464f31a4cfa3d464895f4bbdbf5"
		)
	]
)