...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.37.xcframework.zip",
			checksum: "780d17899b4558f47fae469d2451372b8490e417e5f41d8b8800cc0c7eaf1d48"
		)
	]
)