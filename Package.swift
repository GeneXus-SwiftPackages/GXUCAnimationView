...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-4.1.1.xcframework.zip",
			checksum: "da2fb42fe6149a66eebbdc49530a54874f1144b575087b8dfc4a56252f998b8b"
		)
	]
)