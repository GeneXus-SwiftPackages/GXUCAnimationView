...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.0.0-beta.20230704143346.xcframework.zip",
			checksum: "c8a7df1b3eb83dcdb0b3beebf028cfffc5bef4f785f1028c3f508223b4196d35"
		)
	]
)