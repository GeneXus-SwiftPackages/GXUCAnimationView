...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.18.xcframework.zip",
			checksum: "3c2932527e05935050bc19bdfbc2e78034e5220e851d73643b47b926e743cc63"
		)
	]
)