...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.6.xcframework.zip",
			checksum: "f142e1e61413bf9296fff964271357c3f2ff45199fd74efcdd2f369a539fbe12"
		)
	]
)