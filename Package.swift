...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.40.xcframework.zip",
			checksum: "f82b66d6f6cfb08283bd472ae02dc109ca97aa3c7a10f75bc5d20929d7740bdf"
		)
	]
)