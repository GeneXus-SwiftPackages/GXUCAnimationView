...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.6.0-rc.0.xcframework.zip",
			checksum: "4d7df975862428565568dce596bf32bfd799b7d16ccdf267aa508b5aeb52000c"
		)
	]
)