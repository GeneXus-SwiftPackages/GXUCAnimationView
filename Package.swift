...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.0.0-beta.11.xcframework.zip",
			checksum: "7835e4c4cb0fcceb8eaf5eb2e86f2c45c3966398c628acd3c1b85597d8ca2a3d"
		)
	]
)