...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.0.0-rc.43.xcframework.zip",
			checksum: "bc49bd99743912fb83044fe0198aaa5b6e7ce76b3e4817c384b5ecb8671e7c09"
		)
	]
)