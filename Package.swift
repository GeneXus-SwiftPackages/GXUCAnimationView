...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.16.xcframework.zip",
			checksum: "bccede784f558103031739eb41249bb25abf5477ad7ea7d15f48685b4343b469"
		)
	]
)