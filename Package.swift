...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.17.xcframework.zip",
			checksum: "cce5bdb20ee90735de5680108de0f6b6b79767cf254f0a0590b88b47d3396574"
		)
	]
)