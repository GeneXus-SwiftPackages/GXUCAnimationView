...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.2.0-rc.13.xcframework.zip",
			checksum: "aafb29f14d9064bdbfe4aca95eaa52dd8cf1b73c1be830bb84bb20409326ebdc"
		)
	]
)