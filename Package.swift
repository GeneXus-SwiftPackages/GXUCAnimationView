...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-3.0.1.xcframework.zip",
			checksum: "2cd4c6860c0095b974fbb186c545dbe3554bf6acee69fb42bd5cc72af34d064b"
		)
	]
)