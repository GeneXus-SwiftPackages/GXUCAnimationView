...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.25.xcframework.zip",
			checksum: "4381e0b352b022eb2915de73043b0e84a6634260a19e9f960443764bf42b10d9"
		)
	]
)