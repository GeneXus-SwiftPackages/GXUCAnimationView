...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.2.xcframework.zip",
			checksum: "7efb68a65a5d9586a4ef8b94bb6d81db20a3825c1ea2e9923c289fdd91fd6352"
		)
	]
)