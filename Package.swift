...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.0.0-rc.2.xcframework.zip",
			checksum: "050145428c22b04215bd0bb53fa586f6b57025facf01b6352a04823f6165329e"
		)
	]
)