...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.33.xcframework.zip",
			checksum: "5d0380fe0a133cb431c452b00d2da7ea6c2486aebb17dbe4046ffcbd2bd67cc2"
		)
	]
)