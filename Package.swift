...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-4.1.0-rc.3.xcframework.zip",
			checksum: "d9853dc94c4e440bd1de49c74c16ab600e46f762bdd5f04bb4def41100384124"
		)
	]
)