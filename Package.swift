...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-3.1.0-rc.3.xcframework.zip",
			checksum: "14f6201395a489adf1621e99c2c3c0c8c57c0e0f0723480d74a0251f7e20bb75"
		)
	]
)