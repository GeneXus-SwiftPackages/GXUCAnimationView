...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.27.xcframework.zip",
			checksum: "3f9cfda38a19c87354ee2bc94e0b2ba2cc9be17174a85c0938c82900077796f6"
		)
	]
)