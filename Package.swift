...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.9.xcframework.zip",
			checksum: "b08adefdcc4da3d6a65ebbf107073ecb1922a852fe2fa981e31512bc764d28f2"
		)
	]
)