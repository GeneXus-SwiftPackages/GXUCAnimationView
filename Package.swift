...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.2.0-beta.13.xcframework.zip",
			checksum: "c6cf4ae376459120ea2ce3c27037a74e2bed19c8a756a94bd70f612ca7a6f3dc"
		)
	]
)