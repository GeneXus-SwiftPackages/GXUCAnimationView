...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.39.xcframework.zip",
			checksum: "854ed434e61887f08f2caa1711df38c6e160e28788626b2822424fa4d0c9cbdf"
		)
	]
)