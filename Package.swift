...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.35.xcframework.zip",
			checksum: "d8d6748fb2f7af7e83abb87a235e7fe6219e01998d31cbfbdcb2a07e96dd7020"
		)
	]
)