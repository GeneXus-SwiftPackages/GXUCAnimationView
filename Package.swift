...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.30.xcframework.zip",
			checksum: "6e50c1baee2ffcfadafb794019e05afb2bc859264269bf7226e60369d01231be"
		)
	]
)