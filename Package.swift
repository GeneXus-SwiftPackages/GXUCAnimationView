...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCAnimationView-1.3.0-rc.1.xcframework.zip",
			checksum: "221e0ca94f653907cbbcb08df89a522693d7a0402f51e5a36cef8ee11ac37564"
		)
	]
)