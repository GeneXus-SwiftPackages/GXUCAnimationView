...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-2.0.0-beta.5.xcframework.zip",
			checksum: "df7f3862f8cbeb1beb32d996febc11e21601edcd8342b27140079b6d94ea7da4"
		)
	]
)