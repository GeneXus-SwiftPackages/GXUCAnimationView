...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-1.5.0-beta.12.xcframework.zip",
			checksum: "7147ee50e74f2b5e04d95a1e0dfb5c4e042b5c633403579cb3307d2479ef4236"
		)
	]
)