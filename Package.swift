...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-4.2.0-beta.25.xcframework.zip",
			checksum: "a1d3ccb810d8cb83950638de3253d4d95036f8e3d356f1e878d6c079be50c790"
		)
	]
)