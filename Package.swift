...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.1.0-beta.19.xcframework.zip",
			checksum: "e07376c150fdce6b3040267e39f62b33235d631a98aba2a9bf415427b7c5d909"
		)
	]
)