...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCAnimationView-3.2.0-beta.40.xcframework.zip",
			checksum: "6076e89f8e25e32e49e5046f354c8a4a11fa1a31b04d8dc3e65e6546795d1a3c"
		)
	]
)