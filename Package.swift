...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCAnimationView",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCAnimationView-2.0.12.xcframework.zip",
			checksum: "ffc980976dc309ce8ee0e79835bb86a357766690d8b68fdcd9a7ba88996efb00"
		)
	]
)